...
public class DragLineCtrl1 : MonoBehaviour
    {
        ...
        [SerializeField] protected PathCtrl1 pathCtrl;
        [SerializeField] protected UICtrl1 uICtrl;
        ...
        private void LoadEventSystem()
        {
            ...
            this.levelSO = Resources.Load<LevelSO>("Level_" + this.levelCtrl.level.ToString());
        }
        ...
        private void HandleLineDrawing()
        {
            ...
            if (Input.GetMouseButtonDown(0))
            {
                ...
                if (hit.collider != null)  
                {
                    ...
                    if (this.linePoints.Count > 0) this.prevDot = this.linePoints[this.linePoints.Count - 1];
        ...
        private void AddPointToLine(Transform newPoint)
        {
            ...
            if(this.lineRenderer.Count <= this.numLine)
            {
                lr = Instantiate(line);
            ...
            /*Debug.Log("hellooooooooooooooooooooooooooooooo");
            Debug.Log(index);
            Debug.Log("hiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii");*/
